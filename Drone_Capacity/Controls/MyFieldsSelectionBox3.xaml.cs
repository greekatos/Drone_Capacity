...
public partial class MyFieldsSelectionBox3 : ContentView
{
	public MyFieldsSelectionBox3()
	{
		InitializeComponent();
	}
    ...
    public static readonly BindableProperty TitleProperty =
        BindableProperty.Create(nameof(Title), typeof(string), typeof(MyFieldsSelectionBox3), string.Empty);
    public string Title
    {
    ...
    public static readonly BindableProperty CropImageSourceProperty =
        BindableProperty.Create(nameof(CropImageSource), typeof(ImageSource), typeof(MyFieldsSelectionBox3), default(ImageSource));
    ...
    public static readonly BindableProperty CropNameProperty =
        BindableProperty.Create(nameof(CropName), typeof(string), typeof(MyFieldsSelectionBox3), string.Empty);
    ...
    public static readonly BindableProperty BackGroundColorProperty =
        BindableProperty.Create(nameof(BackGroundColorCode), typeof(string), typeof(MyFieldsSelectionBox3), string.Empty);
    ...
    public static readonly BindableProperty TextColoroneProperty =
        BindableProperty.Create(nameof(TextColorone), typeof(string), typeof(MyFieldsSelectionBox3), string.Empty);
    ...
    public static readonly BindableProperty TextColortwoProperty =
        BindableProperty.Create(nameof(TextColortwo), typeof(string), typeof(MyFieldsSelectionBox3), string.Empty);
    ...
    public static readonly BindableProperty GpsImageSourceProperty =
        BindableProperty.Create(nameof(GpsImageSource), typeof(ImageSource), typeof(MyFieldsSelectionBox3), default(ImageSource));
    ...
    public static readonly BindableProperty LocationProperty =
        BindableProperty.Create(nameof(Location), typeof(string), typeof(MyFieldsSelectionBox3), string.Empty);
    ...
    async void OnBoxTapped3(object sender, EventArgs e)
    {
